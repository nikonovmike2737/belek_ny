...
# Keep the canonical report content and embedded images, but make the stored source print-oriented.
print_css = """
...
@media print {
  ...
  .sticky-compare, .compare-dock, #pdf-download { display: none !important; }
  details { display: block !important; }
  details > * { display: block !important; }
  table { width: 100%; border-collapse: collapse; }
  tr, .hotel-card { break-inside: avoid; }
  img { max-width: 100%; }
}
</style>
"""
